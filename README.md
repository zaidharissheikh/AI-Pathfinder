...
Step-by-Step Visualization: * Orange: Frontier nodes (in queue/stack).
...
Bash
git clone https://github.com/zaidharissheikh/AI-Pathfinder.git
cd AI-Pathfinder
...
AI-Pathfinder/
│
├── pathfinder.py    # Main source code
